  ...
  return `
    <div class="page-container anim-fade-in-up">
        ...
        <main class="space-y-12">
            ...
            <section>
                <h2 class="text-3xl font-bold text-cyan-400 mb-6">Tag Management Tools</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <a href="#/tools/tag-dashboard" data-link class="tool-card content-box">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-cyan-500 mb-2">Tag Dashboard</h2>
                            <p class="text-gray-400">Manage tags, wikis, pools, and posts all in one place.</p>
                        </div>
                    </a>
                </div>
            </section>
            ...
            <section>
                <h2 class="text-3xl font-bold text-cyan-400 mb-6">Post & Pool Tools</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <a href="#/tools/mass-favorite" data-link class="tool-card content-box">
                        <div class="tool-card-icon">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.M0 00-6.364 0z"></path></svg>
                        </div>
                        <div>
            ...
            <section>
                <h2 class="text-3xl font-bold text-gray-600 mb-6">Coming Soon</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
